...
class TradingEnv(gym.Env):
    ...
    def __init__(self, marketSymbol, startingDate, endingDate, testDate, money, stateLength=30,
        ...
        self.state = [self.data['Close'][0:stateLength].tolist(),
                      ...
                      self.data['MACD'][0:stateLength].tolist(),
                      self.data['CCI'][0:stateLength].tolist(),
                      self.data['RSI'][0:stateLength].tolist(),
                      self.data['ADX'][0:stateLength].tolist(),
                      [0]]
        self.reward = 0.
        self.done = 0
    ...
    def reset(self):
        ...
        self.state = [self.data['Close'][0:self.stateLength].tolist(),
                      ...
                      self.data['MACD'][0:self.stateLength].tolist(),
                      self.data['CCI'][0:self.stateLength].tolist(),
                      self.data['RSI'][0:self.stateLength].tolist(),
                      self.data['ADX'][0:self.stateLength].tolist(),
                      [0]]
        self.reward = 0.
        self.done = 0
    ...
    def step(self, action):
        ...
        self.data.loc[t, 'Money'] = self.data['Holdings'].iloc[t] + self.data['Cash'].iloc[t]
        # self.data['Returns'].il[t] = self.data['Holdings'].iloc[t] + self.data['Cash'].iloc[t]
        self.data.loc[t, 'Returns'] = (self.data['Money'].iloc[t] - self.data['Money'].iloc[t-1])/self.data['Money'].iloc[t-1]
        ...
        self.state = [self.data['Close'][self.t - self.stateLength : self.t].tolist(),
                      ...
                      self.data['MACD'][self.t - self.stateLength : self.t].tolist(),
                      self.data['CCI'][self.t - self.stateLength : self.t].tolist(),
                      self.data['RSI'][self.t - self.stateLength : self.t].tolist(),
                      self.data['ADX'][self.t - self.stateLength : self.t].tolist(),
